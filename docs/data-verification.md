...
| ۱۳ | تاریخ‌های سررسید فصلی | **استخراج نشد** — از فرم ۱۰۴۰-ES وارد شود | ⬜ |
| ۱۴ | قواعد safe harbor | **استخراج نشد** — از IRS وارد شود | ⬜ |

**منبع اولیه‌ی موارد ۱ تا ۶:** Rev. Proc. 2025-32 — https://www.irs.gov/pub/irs-drop/rp-25-32.pdf


> ⚠️ موارد ۱۳ و ۱۴ در درخت پارامتر مبدأ نبودند و باید دستی وارد شوند. بدون آن‌ها `/tools/estimated-tax-calculator` — که پرترافیک‌ترین صفحه‌ی طرح است — ساخته نمی‌شود.
