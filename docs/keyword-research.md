...
**نتیجه‌ی اصلاح‌شده:** تقاضا واقعی است، ولی CPC آن $۱.۶۵ است — ارزش بازار ۹۹٬۸۲۵، **پایین‌ترین کل کاتالوگ ۳۶ ابزاره**. و تنها ابزاری است که وابستگی داده‌ی حل‌نشده دارد (Numbeo غیرمجاز، متدولوژی خودمان گران).

یعنی مسئله **نسبت ارزش به هزینه** است، نه نبود تقاضا. در انتهای صف می‌ماند — نه رد‌شده.
